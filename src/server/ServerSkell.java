						...
						if (!catRepo.repoExists(mp.getRepoName())) {
							...
							if (rr.getOwner().equals(mp.getLocalUser().getName())
								...
								try {
									...
									//Recebe chave key para depois cifr�-la usando a sua chave p�blica
									SecretKey key = (SecretKey) in.readObject();
									
									//TODO: CORRIGIR ESTA PARTE: Cifra a chave com a chave p�blica, usando uma keytool (ATEN�AO... AS KEYTOOLS foram criadas antes?!)
